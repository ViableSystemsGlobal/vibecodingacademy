  ...
  return (
    <>
      ...
      {showPreview && !isOpen && !hasDismissedPreview && (
        <div className={`fixed bottom-40 right-4 md:bottom-24 md:right-6 z-50 transition-all duration-300 ${
          isDismissing 
      ...
      <button
        ...
        className={`fixed bottom-28 right-4 md:bottom-6 md:right-6 w-14 h-14 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center z-50 ${
      ...
      {isOpen && (
        <div 
          ref={chatModalRef}
          className="fixed bottom-28 right-4 md:bottom-6 md:right-6 w-96 h-[500px] bg-white rounded-2xl shadow-2xl z-50 flex flex-col border border-gray-200"
        >
          {/* Header */}
          <div 
