...
export function AddProjectModal({ isOpen, onClose, onProjectCreated, initialData }: AddProjectModalProps) {
  ...
  const resetForm = () => {
    ...
    setBudgetCurrency(initialData?.budgetCurrency || "USD");
  };
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // When closing the modal, reset to defaults so reopening starts fresh
    setName("");
    setCode("");
    setDescription("");
    setStatus("ACTIVE");
    ...
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open && !isSubmitting) { onClose(); } }}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Capture the essential details for a new project workspace.
          </DialogDescription>
        </DialogHeader>
